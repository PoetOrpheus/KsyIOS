...
struct TestProducts {
    ...
    static let adidasSneakers = Product(
        ...
        reviewsCount: 457,
        images: [],
        imagesRes: ["adidas_1_1", "adidas_1", "adidas_2", "adidas_2_1"],
        isTimeLimited: false,
    ...
    static let quartzWatch = Product(
        ...
        reviewsCount: 23,
        images: [],
        imagesRes: ["image_for_product_3", "watch_cvarch_1", "watch_cvarch_2", "watch_cvarch_1_2", "watch_cvarch_3"],
        isTimeLimited: true,
    ...
    static let calvinKleinWatch = Product(
        ...
        reviewsCount: 457,
        images: [],
        imagesRes: ["watch_calvin", "watch_calvin_1"],
        isTimeLimited: true,
        accentColorHex: "CC3333",
        isFavorite: true,
    ...
    static let iPhone = Product(
        ...
        reviewsCount: 1234,
        images: [],
        imagesRes: ["iphone_1", "iphone_2", "iphone3"],
        isTimeLimited: false,
